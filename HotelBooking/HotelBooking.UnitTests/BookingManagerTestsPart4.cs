...
namespace HotelBooking.UnitTests
{
    public class BookingManagerTestsPart4
    {
        ...
        [InlineData(21, 2)]
        [InlineData(23, 9)]
        public void CreateBooking_StartAfterOccupiedAndEndBeforeOccupied_LeftDdPath_FindAvailableRoom_AssertThrows(int start, int end)
        {
            List<Booking> bookings = new List<Booking>
            {
                new Booking { Id=1, StartDate=DateTime.Today.AddDays(10), EndDate=DateTime.Today.AddDays(20), IsActive=true, CustomerId=1, RoomId=1 },
        ...
        [InlineData(2, 21)]
        [InlineData(9, 21)]
        public void CreateBooking_StartBeforeOccupiedAndEndAfterOccupied_MiddleDdPath_FindAvailableRoom_AssertFalse(int start, int end)
        {
            List<Booking> bookings = new List<Booking>
            {
                new Booking { Id=1, StartDate=DateTime.Today.AddDays(10), EndDate=DateTime.Today.AddDays(20), IsActive=true, CustomerId=1, RoomId=1 },
        ...
        [InlineData(1, 3)]
        [InlineData(2, 9)]
        public void CreateBooking_StartAndEndBeforeOccupiedDate_RightDdPath_FindAvailableRoom_AssertTrue(int start, int end)
        {
            List<Booking> bookings = new List<Booking>
            {
                new Booking { Id=1, StartDate=DateTime.Today.AddDays(10), EndDate=DateTime.Today.AddDays(20), IsActive=true, CustomerId=1, RoomId=1 },
